...
//TouchableOpacity permite hacer clikeable cualquier cosa
export default function App(){
  ...
  return (
    ...
    <View style={styles.inputContainer}>
      <TextInput placeholder = 'Agregar una nueva tarea' onChangeText={(t: string) => setText(t)} value ={text} style={styles.textInput} />
